...
public class NotNullValidatorTest{
	...
	public void notNullDeveAcionarException(){
		...
		assertEquals(excecaoCorreta && mensagemRetorno.equals("br.com.cdsl.validator.object.PessoaComException.nome: Campo obrigatorio n�o preenchido"), true);
	}
	...
	public void testNotNullWithNotEmptyImplicitNotOk(){
		...
		boolean containsValid1 = str.contains("Valida��o_1");//erro
		boolean containsValid2 = str.contains("Valida��o_2");//erro
		boolean containsValid3 = !str.contains("Valida��o_3");//ok - n�o haver� mensagem
		boolean containsValid4 = !str.contains("Valida��o_4");//ok - n�o haver� mensagem
